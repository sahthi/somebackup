...
/*======================================================================
  ...
  $Header: //components/rel/boot.bf/3.1.2.c2.2/boot_images/core/storage/ufs/src/ufs_utp_core.h#1 $
...
int32_t ufs_utp_uic_getset (ufs_host_t *hdev, uint32_t uic, uint32_t MIBattrIndex, uint32_t *MIBval);
