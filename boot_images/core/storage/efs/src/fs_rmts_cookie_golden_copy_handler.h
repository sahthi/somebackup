...
/*===========================================================================
  ...
  $Header: //components/rel/boot.bf/3.1.2.c2.2/boot_images/core/storage/efs/src/fs_rmts_cookie_golden_copy_handler.h#1 $ $DateTime: 2016/12/12 23:35:46 $ $Author: pwbldsvc $
