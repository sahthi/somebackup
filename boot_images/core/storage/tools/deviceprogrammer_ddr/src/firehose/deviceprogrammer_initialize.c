 ...
 *   order.
 *
 *   $Header: //components/rel/boot.bf/3.1.2.c2.2/boot_images/core/storage/tools/deviceprogrammer_ddr/src/firehose/deviceprogrammer_initialize.c#1 $ 
...
void deviceprogrammer_init_hw() {
    ...
    //modify for QFIL download by zhuhui, 20170621
    /*
