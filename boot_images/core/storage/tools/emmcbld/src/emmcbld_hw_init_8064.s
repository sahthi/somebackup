...
;
; $Header: //components/rel/boot.bf/3.1.2.c2.2/boot_images/core/storage/tools/emmcbld/src/emmcbld_hw_init_8064.s#1 $
;
...
return_here
    ...
    ldr r1, =HWIO_XPU_RESET_ADDR
    ldr r0, =HWIO_XPU_RESET_SCSS_SYS_ASYNC_RESET_BMSK
    str r0, [r1]

    bl dumb_busy_wait

    ldr r1, =HWIO_XPU_RESET_ADDR
    ldr r0, =HWIO_XPU_RESET_SCSS_SYS_POR_ASYNC_RESET_BMSK
    str r0, [r1]
