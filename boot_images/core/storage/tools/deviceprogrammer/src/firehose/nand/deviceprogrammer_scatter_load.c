 ...
 *   order.
 *
 *   $Header: //components/rel/boot.bf/3.1.2.c2.2/boot_images/core/storage/tools/deviceprogrammer/src/firehose/nand/deviceprogrammer_scatter_load.c#1 $
...
void deviceprogrammer_scatter_load(void)
{
   ...
   /*i = 0;   //changed nand deviceprogrammer
