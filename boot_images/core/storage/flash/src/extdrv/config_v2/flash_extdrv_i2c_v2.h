 ...
 *   order.
 *
 *  $Header: //components/rel/boot.bf/3.1.2.c2.2/boot_images/core/storage/flash/src/extdrv/config_v2/flash_extdrv_i2c_v2.h#1 $ $DateTime: 2016/12/12 23:35:46 $ $Author: pwbldsvc $
 *
 *
