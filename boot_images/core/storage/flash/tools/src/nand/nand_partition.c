 ...
 *   order.
 *
 *   $Header: //components/rel/boot.bf/3.1.2.c2.2/boot_images/core/storage/flash/tools/src/nand/nand_partition.c#1 $ $DateTime: 2016/12/12 23:35:46 $ $Author: pwbldsvc $
 *
