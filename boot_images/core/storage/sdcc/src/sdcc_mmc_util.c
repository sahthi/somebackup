...
$Header: //components/rel/boot.bf/3.1.2.c2.2/boot_images/core/storage/sdcc/src/sdcc_mmc_util.c#1 $
...
sdcc_config_mmc_modes_segment( sdcc_dev_type *sdcc_pdev )
{
        ...
        (uint32)(SDCC_MMC_2GB_CARD_SIZE / SDCC_DEFAULT_BLK_LENGTH_SIZE)) )
   {
	  ...
	  // bluebank fix SDINBDG4-8G bug, its card_size_in_sectors is 15273600
	  // if 15273600 div by 512 and then multiplying 512,the result is 15273472
	  // this result not match with linux kernel.
	  sdcc_pdev->mem.mem_info.card_size_in_sectors = 
