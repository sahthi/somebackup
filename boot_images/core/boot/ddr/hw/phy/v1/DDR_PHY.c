...
$Header: //components/rel/boot.bf/3.1.2.c2.2/boot_images/core/boot/ddr/hw/phy/v1/DDR_PHY.c#1 $
...
/*==============================================================================
                                  DATA
==============================================================================*/
static struct ddr_slew_rout_values *cdt_slew_rout_values = (struct ddr_slew_rout_values *)(SHARED_IMEM_DDR_PARAM_BASE + sizeof(struct ddr_device_params_header_v1) + (sizeof(struct ddr_device_params_lpddr)*2) + (sizeof(struct ddr_cdc_delay_values)));
...
void HAL_SDRAM_PHY_Init(uint32 base, SDRAM_INTERFACE interface, uint32 clk_speed)
{
  ...
  if(cdt_slew_rout_values->cdc_cdt_feature == 0x1)
  {
   //Update CA PAD_CFG0 values
   BOOT_HWIO_OUTM(PHY_CA_ADDR(PAD_CFG0), phy_offset + PHY_CA_MST_OFFSET,
   
                 HWIO_FMSK(PHY_CA_ADDR(PAD_CFG0), CA_NSLEW) |
                 HWIO_FMSK(PHY_CA_ADDR(PAD_CFG0), CA_PSLEW) |
                 HWIO_FMSK(PHY_CA_ADDR(PAD_CFG0), CA_ROUT),

                 cdt_slew_rout_values->ca_nslew[0] << HWIO_SHFT(PHY_CA_ADDR(PAD_CFG0), CA_NSLEW) |
                 cdt_slew_rout_values->ca_pslew[0] << HWIO_SHFT(PHY_CA_ADDR(PAD_CFG0), CA_PSLEW) |
                 cdt_slew_rout_values->ca_rout[0] << HWIO_SHFT(PHY_CA_ADDR(PAD_CFG0), CA_ROUT));
    
   //Update CA PAD_CFG1 values
   BOOT_HWIO_OUTM(PHY_CA_ADDR(PAD_CFG1), phy_offset + PHY_CA_MST_OFFSET,
   
                 HWIO_FMSK(PHY_CA_ADDR(PAD_CFG1), CK_NSLEW) |
                 HWIO_FMSK(PHY_CA_ADDR(PAD_CFG1), CK_PSLEW) |
                 HWIO_FMSK(PHY_CA_ADDR(PAD_CFG1), CK_ROUT),

                 cdt_slew_rout_values->ca_nslew[1] << HWIO_SHFT(PHY_CA_ADDR(PAD_CFG1), CK_NSLEW) |
                 cdt_slew_rout_values->ca_pslew[1] << HWIO_SHFT(PHY_CA_ADDR(PAD_CFG1), CK_PSLEW) |
                 cdt_slew_rout_values->ca_rout[1] << HWIO_SHFT(PHY_CA_ADDR(PAD_CFG1), CK_ROUT));
				 
   //Update DQ PAD_CFG0 values
   BOOT_HWIO_OUTM(PHY_DQ_ADDR(PAD_CFG0), phy_offset + DQ_BCAST_OFFSET,
   
                 HWIO_FMSK(PHY_DQ_ADDR(PAD_CFG0), DQ_NSLEW) |
                 HWIO_FMSK(PHY_DQ_ADDR(PAD_CFG0), DQ_PSLEW) |
                 HWIO_FMSK(PHY_DQ_ADDR(PAD_CFG0), DQ_ROUT),

                 cdt_slew_rout_values->dq_nslew[0] << HWIO_SHFT(PHY_DQ_ADDR(PAD_CFG0), DQ_NSLEW) |
                 cdt_slew_rout_values->dq_pslew[0] << HWIO_SHFT(PHY_DQ_ADDR(PAD_CFG0), DQ_PSLEW) |
                 cdt_slew_rout_values->dq_rout[0] << HWIO_SHFT(PHY_DQ_ADDR(PAD_CFG0), DQ_ROUT));
				 
   //Update DQ PAD_CFG1 values
   BOOT_HWIO_OUTM(PHY_DQ_ADDR(PAD_CFG1), phy_offset + DQ_BCAST_OFFSET,
   
                 HWIO_FMSK(PHY_DQ_ADDR(PAD_CFG1), DQS_NSLEW) |
                 HWIO_FMSK(PHY_DQ_ADDR(PAD_CFG1), DQS_PSLEW) |
                 HWIO_FMSK(PHY_DQ_ADDR(PAD_CFG1), DQS_ROUT),

                 cdt_slew_rout_values->dq_nslew[1] << HWIO_SHFT(PHY_DQ_ADDR(PAD_CFG1), DQS_NSLEW) |
                 cdt_slew_rout_values->dq_pslew[1] << HWIO_SHFT(PHY_DQ_ADDR(PAD_CFG1), DQS_PSLEW) |
                 cdt_slew_rout_values->dq_rout[1] << HWIO_SHFT(PHY_DQ_ADDR(PAD_CFG1), DQS_ROUT));
  }
