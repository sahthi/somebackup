...
$Header: //components/rel/boot.bf/3.1.2.c2.2/boot_images/core/boot/ddr/hw/msm8909/ddr_func_tbl.h#1 $
...
typedef struct 
{
  ...
  void (*phy_update_ca_cdc_config_cdt) (uint32 base, SDRAM_INTERFACE interface, uint16 config);
  void (*phy_update_dq_cdc_config_cdt) (uint32 base, SDRAM_INTERFACE interface, uint32 dq_rd_wr, uint16 config[4]);
