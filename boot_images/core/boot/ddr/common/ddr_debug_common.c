...
$Header: //components/rel/boot.bf/3.1.2.c2.2/boot_images/core/boot/ddr/common/ddr_debug_common.c#1 $
$DateTime: 2016/12/12 23:35:46 $
$Author: pwbldsvc $
================================================================================
when       who     what, where, why
--------   ---     -------------------------------------------------------------
11/17/15   sc      Fixed KW errors
...
void ddr_debug_output(const char *msg)
{
  ...
  strlcpy(msg_buf, msg, BUFFER_LENGTH);
