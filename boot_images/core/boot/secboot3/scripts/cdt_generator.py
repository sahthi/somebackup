...
#  $Header: //components/rel/boot.bf/3.1.2.c2.2/boot_images/core/boot/secboot3/scripts/cdt_generator.py#1 $
...
SizeOfLastCDB = 0
HeaderandMetaSize = NumHeaderBytes + SizeOfMetaData

MetaData = ''

for i in range(NumCDBs):
    DistanceInBytesToCDB = HeaderandMetaSize + SizeOfLastCDB
    ...
    HeaderandMetaSize = DistanceInBytesToCDB
