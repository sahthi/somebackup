...
============================================================================
  $Header: //components/rel/boot.bf/3.1.2.c2.2/boot_images/core/systemdrivers/chipinfo/src/DalChipInfoLocal.c#2 $
  $DateTime: 2016/12/14 06:21:56 $
  $Author: pwbldsvc $
...
#define DALCHIPINFO_PARTNUM_MSM8905        0x094
...
DalChipInfoPartMapType amPartMap[] =
{
  ...
  { DALCHIPINFO_PARTNUM_MSM8905,    DALCHIPINFO_ID_MSM8905   },
};
...
static const DalChipInfoDataLUTType DalChipInfoDataLUT[DALCHIPINFO_CHIPID_MAP_SIZE] =
{
  ...
  { "MSM8905",     DALCHIPINFO_FAMILY_MSM8909,  DALCHIPINFO_MODEM_WWAN | DALCHIPINFO_MODEM_CGPS | DALCHIPINFO_MODEM_LTE },
};
