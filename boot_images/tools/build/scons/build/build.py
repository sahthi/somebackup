...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/boot.bf/3.1.2.c2.2/boot_images/tools/build/scons/build/build.py#1 $
...
if __name__ == "__main__":
   ...
   try:
      ...
      lg.log("Running $Header: //components/rel/boot.bf/3.1.2.c2.2/boot_images/tools/build/scons/build/build.py#1 $")
